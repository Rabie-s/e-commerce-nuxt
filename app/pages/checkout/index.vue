...
<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div
        v-if="orderSuccess"
        class="mb-8 bg-green-50 border border-green-200 rounded-2xl p-6 text-center"
      >
        <svg class="w-16 h-16 mx-auto text-green-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
        </svg>
        <h2 class="text-2xl font-bold text-green-900 mb-2">Order Placed Successfully!</h2>
        <p class="text-green-700">Redirecting to your order details...</p>
      </div>
            ...
            <form @submit.prevent="submitOrder" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    :class="[
                      'w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-colors',
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  :class="[
                    'w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-colors resize-none',
              ...
              <div>
                <label for="nearby_landmark" class="block text-sm font-medium text-gray-700 mb-1">
                  Nearby Landmark <span class="text-gray-400">(Optional)</span>
                </label>
                <input
                  id="nearby_landmark"
                  ...
                  :class="[
                    'w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-colors',
                    errors.nearby_landmark ? 'border-red-300 focus:ring-red-500' : 'border-gray-300'
                  ]"
              ...
              <button
                ...
                class="w-full py-4 bg-gray-900 text-white rounded-xl hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed font-semibold text-lg transition-all hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center justify-center gap-3"
              >
